            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    buffer.append("<td><a href=\"#m").append(scenarioIndex)
                            ...
                            .append(resultsCount).append("\" align=\"center\">").append(DateTimeUtils.convertMillisecondsToDate(start))
                            .append("</td>").append("<td rowspan=\"")
                            .append(resultsCount).append("\" align=\"center\">")
                            .append(DateTimeUtils.convertMillisecondsToDuration(duration)).append("</td></tr>");
                    scenarioIndex++;
